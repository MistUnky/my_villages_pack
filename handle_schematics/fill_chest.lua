...
--ADD_RCC({node,                             1, 1, 1, wreck=1, farm_tiny=1, farm_full=1, shed=1, lumberjack=1, hut=1, chest_work=1, forge=1, guard=1, ship=1, church=1, library=1, chest_private=1, shelf=1, shed=1, chest_storage=1})
...
minetest.register_on_mods_loaded(function()
	for name, def in pairs(minetest.registered_items) do
		if item ~= "" and item ~= "air" and item ~= "ignore" and item ~= "unknown"
			...
			ADD_RCC({name, 2, 1, 2, wreck=1, farm_tiny=1, farm_full=1, shed=1, lumberjack=1, hut=1, chest_work=1, forge=1, guard=1, ship=1, church=1, library=1, chest_private=1, shelf=1, shed=1, chest_storage=1})
			ADD_RCC({name, 2, 1, 2})
		end
	end
end)
